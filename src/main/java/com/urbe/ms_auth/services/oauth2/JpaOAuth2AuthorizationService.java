package com.urbe.ms_auth.services.oauth2;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.Module;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.urbe.ms_auth.entity.oauth2.Authorization;
import com.urbe.ms_auth.repository.oauth2.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        } else if (OidcIdToken.class.getSimpleName().equals(tokenType.getValue())) {
